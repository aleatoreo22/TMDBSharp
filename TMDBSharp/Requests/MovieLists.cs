...
public class MovieListsClient
{
    ...
    /// <returns></returns>
    public async Task<BaseListRequest<Movie>?> GetPopular(
        int page = 1,
    ...
    /// <param name="region">ISO-3166-1 code</param>
    /// <returns></returns>
    public async Task<BaseListRequest<Movie>?> GetNowPlaying(
        int page = 1,
        string language = "en-US",
        string? region = null
    )
    ...
    /// <param name="region">ISO-3166-1 code</param>
    /// <returns></returns>
    public async Task<BaseListRequest<Movie>?> GetTopRated(
        int page = 1,
        string language = "en-US",
        string region = ""
    )
    ...
    /// <param name="language"></param>
    /// <param name="region">ISO-3166-1 code</param>
    public async Task<BaseListRequest<Movie>?> GetUpcoming(
        int page = 1,
        string language = "en-US",
        string region = ""
    )
